...
class SequentialMiniImagenetOnline(ContinualDataset):

    NAME = 'seq-miniimg-online'
    SETTING = 'class-il'
    ...
    @staticmethod
    def get_backbone():
        return lopeznet(SequentialMiniImagenetOnline.N_CLASSES_PER_TASK
                        * SequentialMiniImagenetOnline.N_TASKS)
    ...
    def get_normalization_transform():
        transform = transforms.Normalize(SequentialMiniImagenetOnline.MEAN,
                                         SequentialMiniImagenetOnline.STD)
        return transform

    @staticmethod
    def get_denormalization_transform():
        transform = DeNormalize(SequentialMiniImagenetOnline.MEAN,
                                SequentialMiniImagenetOnline.STD)
        return transform
