...
def store_masked_loaders(train_dataset: datasets, test_dataset: datasets,
    ...
    train_loader = DataLoader(train_dataset,
                            batch_size=dset_args.batch_size, shuffle=True, num_workers=4, drop_last=True)
    test_loader = DataLoader(test_dataset,
                            batch_size=dset_args.batch_size, shuffle=False, num_workers=4)
