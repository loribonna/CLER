...
class SequentialCIFAR100Online(ContinualDataset):

    NAME = 'seq-cifar100-online'
    SETTING = 'class-il'
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialCIFAR100Online.TRANSFORM])
        return transform

    @staticmethod
    def get_backbone():
        return resnet18(SequentialCIFAR100Online.N_CLASSES_PER_TASK
                        * SequentialCIFAR100Online.N_TASKS)
