...
def get_parser() -> ArgumentParser:
    parser = ArgumentParser(description='Relation-Guided Representation Learning for Data-Free Continual Learning (with Equivariant pretext task)')
...
class RDFCILPretext(PretextModel):
    NAME = 'rdfcil_pretext'
